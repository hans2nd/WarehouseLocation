                    ...
                    <div style="display: flex; flex-direction: column; gap: 12px; text-align: left;">
                        ...
                        <label style="display: flex; align-items: center; padding: 12px; border: 2px solid #e5e7eb; border-radius: 8px; cursor: pointer; transition: all 0.2s;"
                            ...
                            <div>
                                ...
                                <p style="font-size: 12px; color: #6b7280; margin: 0;">Layout A4 untuk rak double deep (a=LUAR, b=DALAM)</p>
                            </div>
                        </label>
                        <label style="display: flex; align-items: center; padding: 12px; border: 2px solid #e5e7eb; border-radius: 8px; cursor: pointer; transition: all 0.2s;"
                               onmouseover="this.style.borderColor='#3b82f6'" onmouseout="this.style.borderColor='#e5e7eb'">
                            <input type="radio" name="swal-print-type" value="ground_shelving" style="margin-right: 12px; width: 18px; height: 18px;">
                            <div>
                                <strong style="color: #1f2937;">🏗️ Ground Shelving</strong>
